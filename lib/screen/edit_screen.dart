...
class Edit_Screen extends StatefulWidget {
  final String type;
  final Todo _todo;
  const Edit_Screen(this._todo, {super.key, required this.type});
...
class _Edit_ScreenState extends State<Edit_Screen> {
  ...
  void initState() {
    ...
    description = TextEditingController(text: widget._todo.description);
  }
        ...
        ElevatedButton(
          ...
          onPressed: () {
            Firestore_Datasource().Update_Todo(
                widget._todo.id, title!.text, description!.text, widget.type);
            Navigator.pop(context);
          },
          child: Text(
            'Update Todo',
